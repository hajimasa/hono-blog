...
// .wrangler/tmp/bundle-owCWqe/checked-fetch.js
...
// src/microcms.ts
var MicroCMSClient = class {
  static {
    __name(this, "MicroCMSClient");
  }
  serviceDomain;
  apiKey;
      ...
      <body>
        ...
        <article>
          ...
          <div class="post-meta">
            ...
            ${post.updatedAt !== post.publishedAt ? ` | \u66F4\u65B0\u65E5: ${new Date(post.updatedAt).toLocaleDateString("ja-JP")}` : ""}
          </div>
...
// .wrangler/tmp/bundle-owCWqe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-owCWqe/middleware-loader.entry.ts
